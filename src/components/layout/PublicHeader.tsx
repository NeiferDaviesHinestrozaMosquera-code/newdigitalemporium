            ...
            user ? (
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href={`/${lang}/login`}>
                  <LogIn className="mr-2 h-4 w-4" /> {dictionary.adminLogin as string}
                </Link>
              </Button>
            )
          )}
              ...
              <nav className="flex flex-col space-y-2 mt-6">
                {currentNavLinks.map((link) => (
                 ...
                 {!loading && (
                    ...
                    <Button variant="default" className="w-full justify-start text-base py-2.5 px-3" asChild>
                        <Link href={`/${lang}/login`} onClick={() => setIsSheetOpen(false)}>
                          <LogIn className="mr-3 h-5 w-5" /> {dictionary.adminLogin as string}
                        </Link>
                    </Button>
                    )
                )}
